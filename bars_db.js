...
MongoClient.connect(connectionURL, { useNewUrlParser: true }, (error, client) => {
    ...
    db.collection('billings').insertMany([{
        ...
        amount: 7000,
        start_date: new Date(2013, 0, 15, 0),
        end_date: new Date(2013, 1, 14, 0),
        last_edited: 'admin',
        account: {
        ...
        billing_month: "January",
        amount: 15000,
        start_date: new Date(2016, 0, 16, 0),
        end_date: new Date(2016, 1, 15, 0),
        last_edited: 'admin',
        account: {
        ...
        amount: 10000,
        start_date: new Date(2016, 1, 2, 0),
        end_date: new Date(2016, 1, 29, 0),
        last_edited: 'admin',
        account: {
            account_name: 'STEPHEN ABAD',
            date_created: new Date(),
        ...
        billing_month: "January",
        amount: 25000,
        start_date: new Date(2016, 0, 2, 0),
        end_date: new Date(2016, 1, 1, 0),
        last_edited: 'admin',
        account: {
